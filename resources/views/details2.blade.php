        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
              ...
              <video width="500" height="400" controls>
                <source src="..\storage\multimedias\{{$post->name}}" type="audio/mp3">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Category</strong>: {{$post->_type}}</li>
                <li><strong>Posted by</strong>: {{$exp->name}}</li>
                <li><strong>Project date</strong>: {{$post->created_at}}</li>
                
                <li><strong><a href="..\storage\multimedias\{{$post->name}}">Download</a></strong>
              </ul>
            </div>
