...
<section id="portfolio" class="portfolio">
    <div class="container">
      ...
      <ul id="portfolio-flters" class="d-flex justify-content-center">
        ...
        <li data-filter=".filter-psychology">PSYCHOLOGY</li>
        <li data-filter=".filter-fiction">FICTION</li>
      </ul>
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-psychology">
          <div class="portfolio-img"><img src="..\storage\books\{{$post->cover}}" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>{{$post->title}}</h4>
           
            <a href="..\storage\books\{{$post->cover}}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Book 1"><i class="bx bx-plus"></i></a>
            <a href="posts/{{$post->id}}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>  
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-educational">
          <div class="portfolio-img"><img src="..\storage\books\{{$post2->cover}}" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>{{$post2->title}}</h4>
            
            <a href="..\storage\books\{{$post2->cover}}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
            <a href="posts/{{$post2->id}}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
        @endforeach
        @foreach ($posts3 as $post3)
        
        <div class="col-lg-4 col-md-6 portfolio-item filter-fiction">
          <div class="portfolio-img"><img src="..\storage\books\{{$post3->cover}}" class="img-fluid" alt=""></div>
          <div class="portfolio-info">
            <h4>{{$post3->title}}</h4>
            <a href="..\storage\books\{{$post3->cover}}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
            <a href="posts/{{$post3->id}}" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
          </div>
        </div>
        @endforeach
